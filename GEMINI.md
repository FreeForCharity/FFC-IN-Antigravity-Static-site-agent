# Gemini Instructions: FFC-IN-Antigravity-Static-site-agent

Hey Gemini! Welcome to FFC-IN-Antigravity-Static-site-agent.

**Project:** FFC-IN-Antigravity-Static-site-agent -- a Free For Charity nonprofit website
...
The site deploys to `https://freeforcharity.github.io/FFC-IN-Antigravity-Static-site-agent/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
