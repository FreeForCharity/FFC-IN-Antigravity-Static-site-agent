# Claude Code Instructions: FFC-IN-Antigravity-Static-site-agent

Welcome, Claude! This document provides specific instructions for working on FFC-IN-Antigravity-Static-site-agent.
