# AI Agent Instructions: FFC-IN-Antigravity-Static-site-agent
...
These sites deploy to `https://freeforcharity.github.io/FFC-IN-Antigravity-Static-site-agent/` and optionally to a custom domain if one is configured for this repo.
